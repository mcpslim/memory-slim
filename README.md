...
> **Memory MCP server optimized for AI assistants** — Reduce context window tokens by 55.3% while keeping full functionality. Compatible with Claude, ChatGPT, Gemini, Cursor, and all MCP clients.
...
`memory-slim` intelligently **groups 9 tools into 5 semantic operations**, reducing token usage by **55.3%** — with **zero functionality loss**.
...
|--------|----------|------|-----------|
| Tools | 9 | 5 | **-44%** |
| Schema Tokens | 2,054 | 364 | **82.3%** |
| Claude Code (est.) | ~7,184 | ~3,214 | **~55.3%** |
...
**Zero functionality loss. 55.3% token savings.**
